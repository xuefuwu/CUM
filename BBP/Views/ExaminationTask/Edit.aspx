...
<asp:Content ID="Content2" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <% BBP.ExaminationTask et = (BBP.ExaminationTask)Model; %>
    <input value="<%:et.ID %>" name="ID" id="ID" type="hidden" />
    <div class="col-md-12">
        <div class="form-group">
            <label class="col-sm-3 control-label">标题：</label>
            <div class="col-sm-9 input-group">
                <input type="text" name="Title" id="Title" class="form-control" placeholder="请输入任务标题" value="<%:et.Title %>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9 input-group date">
                ...
                <input type="text" name="DueDate" id="DueDate" class="form-control" placeholder="请输入截至时间" value="<%:et.DueDate.ToString("d") %>">
            </div>
        </div>
        <div class="form-group">
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <%
                                    foreach (BBP.ExamQuestion eq in et.Questions)
                                    {
                                %>
                                <tr>
                                    <td>

                                        <input type="checkbox" class="i-checks" name="Question" value="<%: eq.Question.ID %>" checked>
                                    </td>
                                    <td><%: eq.Question.Title %></td>
                                    <td>
                                        <input type="text" name="QuestionScore" value="<%: eq.Score %>" />
                                    </td>
                                </tr>
                                <%
                                    }
    ...
    <script>
        $(function () {
            ...
            $(".btn-submit").click(function () {
                $("form").attr("action", "/ExaminationTask/Edit");
                $("form").submit();
            });
            $('#DueDate').datepicker({
                format: 'yyyy/mm/dd',
