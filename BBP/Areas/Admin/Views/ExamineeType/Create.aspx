...
<asp:Content ID="Content2" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="TypeName" name="TypeName" class="form-control" placeholder="请输入文本">
            </div>
        </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="JSContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            // Setup buttons
            $("#table_attrs").jqGrid('navGrid', '#pager_attrs', {
                edit: false,
                add: false,
                del: true,
                search: false
                ...
                onClickButton: function () {
                    $("#table_attrs").jqGrid('editGridRow', "new", {
            ...
            $(".btn-submit").click(function () {
                ...
                $(obj).each(function () {
                    var rowdata = {
                        "ValueType": { "ID": Number(this.ValueType), "ValueTypeName": selectdata[Number(this.ValueType)] },
                ...
                var s = { TypeName: $("#TypeName").val(), ExTAttrs: JsonArray };
                //alert(JSON.stringify(s));
                $.ajax({
                    type: "POST",
                    url: "/Admin/ExamineeType/Create",
