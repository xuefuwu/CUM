...
<asp:Content ID="Content2" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <% BBP.Examination ex = (BBP.Examination)Model; %>
    <div class="col-md-12">
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <% foreach (BBP.QuestionResult q in ex.QuestionResults)
                                   {
                                %>
                                <tr>
                                    <td><%:q.Question.Question.Title %></td>
                                    <td><%:Convert.ToBoolean(q.QuestionAnswer)?"合格":"不合格"%></td>
                                    <td><%:Convert.ToBoolean(q.QuestionAnswer)?q.Question.Score.ToString():"0("+q.Question.Score+")"%></td>
                                </tr>
                                <%   } %>
                            </tbody>
                        </table>
