...
<asp:Content ID="Content2" ContentPlaceHolderID="FormContent" runat="server">
    ...
    <input type="hidden" value="<%:ViewData["returnAction"] %>" name="returnAction" />
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-sm-3 control-label">订单号：</label>
            <div class="col-sm-9">
                <input type="text" name="Order.OrderNo" class="form-control" placeholder="请输入订单号" value="<%:((BBP.Order)Model).OrderNo %>">
    ...
    <script>
        $(document).ready(function () {
            $(".btn-submit").click(function () {
                $("form").attr("action", "/RepairDetail/Add");
                $("form").submit();
            });
